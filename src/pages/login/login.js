...
const useStyles = makeStyles((theme) => ({
  ...
  loginButton: {
    ...
    background:
      "linear-gradient(90deg, rgba(240,240,240,1) 0%, rgb(197, 215, 227) 30%)",
  },
  loginButtonContent: {
    margin: "12px",
    color: "current-color",
...
function Login() {
  ...
  return (
    <div className={classes.login}>
      ...
      <div onClick={value.login} className={classes.loginButton}>
        <Typography className={classes.loginButtonContent}>
          Get Started
        </Typography>
      </div>
